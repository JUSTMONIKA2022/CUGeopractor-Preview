...
>若遇到使用问题请及时反馈开发者（issue区或邮箱均可），开发者会尽快给出回应。<br>
>本项目将在未来会继续完善、优化和拓展功能。<br>
>目前版本为 *__The Embodiment of Scarlet Devil.__*
...
- 本声明仅为简短描述，具体以 [免责声明]免责声明.md) 为准。

## 最后

再次感谢使用本agent，也欢迎在本项目的基础上做对其他院校的适配，<br>
也希望能启发其他开发者开发更好的校园agent。（~~毕竟现在还是比较简陋的技术状态，到时候直接用别人的了~~）<br>
欢迎在使用时可通过issue或邮箱的方式提出任何体验上的反馈和建议，开发者将会在短时间内给予回复。<br>
欢迎同样喜欢ai技术的同学参与到本项目之中来 ━(*｀∀´*)ノ亻!
